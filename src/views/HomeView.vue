<template>
  <main
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="280" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-100 pict" src="https://vault.pictures/media/images/9f/c0/93/9fc093a5574844b096b429da80cee00c.jpg">
    </div>
  </main>
</template>
